...
depends_on:
  ...
  - artifact: "specs/architecture-cible-fastapi-clerk-flutter.md"
    artifact_version: "0.1.0"
...
next_step: "/sf-docs update ARCHITECTURE.md"
---

# ARCHITECTURE.md — contentflow_app (Flutter + FastAPI + Clerk)
