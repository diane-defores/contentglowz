...
import 'package:contentflow_app/presentation/screens/onboarding/onboarding_screen.dart';
...
void main() {
  testWidgets(
    ...
    (tester) async {
      ...
      expect(find.text('Fermer ContentFlow ?'), findsNothing);

      await tester.binding.handlePopRoute();
      await tester.pumpAndSettle();

      expect(find.text('Fermer ContentFlow ?'), findsOneWidget);
      expect(
