...
class ScreenCaptureChannel(
    ...
    private val methodChannel = MethodChannel(messenger, "contentflow/device_capture")
    private val eventChannel = EventChannel(messenger, "contentflow/device_capture_events")
