...
depends_on:
  ...
  - artifact: "shipflow_data/workflow/specs/contentflow_app/architecture-cible-fastapi-clerk-flutter.md"
    artifact_version: "0.1.0"
...
supersedes: []
linked_systems:
  - "contentflow_lab FastAPI services"
  - "contentflow_site marketing surface"
  - "ClerkJS auth"
...
# shipflow_data/technical/architecture.md — contentflow_app (Flutter + FastAPI + Clerk)
