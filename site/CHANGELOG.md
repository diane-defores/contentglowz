...
### Added
- Added `shipflow_data/business/site/branding.md` to document the ContentGlowz website brand promise, tone, and UX language.
...
### Changed
- Brand name harmonized to "ContentGlowz" across all 46 files (components, layouts, content, schema.org, OG tags)
...
- PostHog analytics replaced with cookie-free ContentGlowz analytics (<1KB, EU-hosted)
...
- Brand naming harmonized to "ContentGlowz" across navbar, footer, hero, schema.org, og:site_name (R7)
