...
| --- | --- | --- | --- | --- |
| `/` via `src/pages/index.astro` | Explain ContentGlowz and move qualified visitors toward the app | Open app or start/sign in | `shipflow_data/business/business.md`, `shipflow_data/business/product.md`, `shipflow_data/business/gtm.md` | High: homepage copy affects positioning and claims |
