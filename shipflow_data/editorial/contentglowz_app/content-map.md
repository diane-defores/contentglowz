...
evidence:
  ...
  - "README.md"
  - "CLAUDE.md"
  - "shipflow_data/workflow/specs/contentglowz_app/*.md"
  - "CHANGELOG.md"
...
- `shipflow_data/workflow/specs/contentglowz_app/*.md` (active spec set for current and next implementation phase).
