...
- `shipflow_data/product/app/product.md` - l'app porte les workflows idées, recherche, éditeur, personas et contenus.
- `shipflow_data/product/lab/product.md` - le lab porte les APIs, agents, recherche, contenus, jobs et observabilité.
