...
evidence:
  - "shipflow_data/workflow/specs/contentflow_app/SPEC-android-device-screen-capture.md defines Android MediaProjection local-only PNG/MP4 capture."
  - "shipflow_data/workflow/specs/contentflow_app/SPEC-local-capture-assets-linked-to-content.md keeps media local and stores only asset metadata server-side."
...
- `shipflow_data/workflow/specs/contentflow_app/SPEC-android-device-screen-capture.md` - Confirms V1 is Android MediaProjection, local-only, with screenshot and recording outputs saved as PNG/MP4.
- `shipflow_data/workflow/specs/contentflow_app/SPEC-local-capture-assets-linked-to-content.md` - Confirms captures may be linked to content but raw files remain local in V1.
