...
supersedes: []
evidence: []
next_step: "/sf-docs audit shipflow_data/workflow/specs/lab/DRIP_IMPLEMENTATION.md"
---
...
- Valider la source de verite finale entre cette analyse et `shipflow_data/workflow/specs/lab/DRIP_IMPLEMENTATION.md` pour eviter une double maintenance.
