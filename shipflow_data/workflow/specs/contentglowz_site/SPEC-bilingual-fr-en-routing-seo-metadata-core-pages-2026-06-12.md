...
depends_on:
  ...
  - artifact: "shipflow_data/editorial/contentglowz_site/content-map.md"
    artifact_version: "1.0.0"
    required_status: "reviewed"
  - artifact: "shipflow_data/editorial/contentglowz_site/page-intent-map.md"
    artifact_version: "0.1.0"
    required_status: "draft"
  - artifact: "shipflow_data/editorial/contentglowz_site/editorial-update-gate.md"
    artifact_version: "0.1.0"
    required_status: "draft"
  - artifact: "shipflow_data/editorial/contentglowz_site/claim-register.md"
    artifact_version: "0.1.0"
    required_status: "draft"
...
next_step: "/101-sf-ready shipflow_data/workflow/specs/contentglowz_site/SPEC-bilingual-fr-en-routing-seo-metadata-core-pages-2026-06-12.md"
---
...
- `shipflow_data/editorial/contentglowz_site/content-map.md`: scope authority for landing and conversion pages.
- `shipflow_data/editorial/contentglowz_site/page-intent-map.md`: route intent and CTA constraints.
- `shipflow_data/editorial/contentglowz_site/editorial-update-gate.md`: required editorial closure path for public-copy changes.
- `shipflow_data/editorial/contentglowz_site/claim-register.md`: claim guardrails for AI, privacy, pricing, and outcome wording.
...
- Update `shipflow_data/workflow/contentglowz_site/TASKS.md` and closure artifacts during lifecycle end, not during spec creation.
