...
- Ready visual asset spec: `shipflow_data/workflow/specs/app/SPEC-editor-linked-ai-visuals-ui-2026-05-11.md`.
...
- Then read: `shipflow_data/technical/app/guidelines.md`, `shipflow_data/technical/lab/guidelines.md`, `app/lib/router.dart`, `app/lib/presentation/screens/editor/editor_screen.dart`, `lab/api/services/job_store.py`, `lab/api/dependencies/auth.py`, and `lab/api/dependencies/ownership.py`.
