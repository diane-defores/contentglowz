...
depends_on:
  ...
  - artifact: "shipflow_data/technical/site/architecture.md"
    artifact_version: "0.1.0"
    required_status: "draft"
supersedes: []
evidence:
...
- `shipflow_data/technical/site/architecture.md`: update content collection architecture from `src/content/config.ts` to `src/content.config.ts` if present.
- `shipflow_data/editorial/site/content-map.md`: update only if route paths or content folders change.
...
- [ ] Tâche 13 : Mettre à jour la documentation minimale
  - Fichier : `README.md`, `CLAUDE.md`, `shipflow_data/technical/site/architecture.md`, `CHANGELOG.md`
  ...
  - Depends on : Tâche 12.
  - Validate with : revue de diff; `rg -n "Astro 5|src/content/config.ts|Node 20|node 20|legacy collections" README.md CLAUDE.md shipflow_data/technical/site/architecture.md CHANGELOG.md`.
