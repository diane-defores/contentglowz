...
- Mettre à jour `shipflow_data/workflow/specs/app/SPEC-migrate-flutter-core-majors.md` (ou issue liée) si la résolution `record` influence une feuille de route globale de migration.
...
- [ ] Tâche 5: Packager la décision de lot
  - Fichier : `shipflow_data/workflow/specs/app/SPEC-record-package-migration-flutter-3-41.md`
