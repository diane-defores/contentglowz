...
depends_on:
  ...
  - artifact: "shipflow_data/workflow/specs/app/SPEC-android-privacy-capture-dynamic-redaction.md"
    artifact_version: "0.1.0"
    required_status: "draft"
  - artifact: "shipflow_data/workflow/specs/app/SPEC-web-privacy-capture-dynamic-redaction.md"
    artifact_version: "0.1.0"
    required_status: "draft"
  - artifact: "shipflow_data/workflow/specs/app/SPEC-windows-privacy-capture-dynamic-redaction.md"
    artifact_version: "0.1.0"
    required_status: "draft"
...
- Update `shipflow_data/technical/app/guidelines.md` with no-clear compare policy, local-only review metadata rules, and banned guarantee copy.
- Update `shipflow_data/technical/app/flutter-app-shell-and-capture.md` with the shared privacy review gate and platform-specific ownership split.
...
- [ ] Task 11: Update docs for privacy review behavior.
  - File: `app/README.md`, `shipflow_data/technical/app/guidelines.md`, `shipflow_data/technical/app/flutter-app-shell-and-capture.md`, `app/CHANGELOG.md`
