...
- Review `shipflow_data/technical/app/guidelines.md`, `app/README.md`, and settings/onboarding support copy for GitHub-only project language. Update any text that says projects must be GitHub repositories.
