...
- `shipflow_data/technical/app/architecture.md`: mettre a jour si un nouveau modele/table `ProjectPublishAccount` devient un contrat durable.
...
|----------|-------|-------|--------|--------|-----------|
| 2026-04-28 02:25 | continue | GPT-5 | Ajout de la decision cle Zernio partagee + mapping comptes sociaux par user/projet | Spec mise a jour en 1.1.0 | /sf-ready shipflow_data/workflow/specs/app/late-integration-finalization.md |
