...
- `contentglowz_app/README.md`, `shipflow_data/technical/app/guidelines.md`, `contentglowz_app/CHANGELOG.md`, and `shipflow_data/technical/app/flutter-app-shell-and-capture.md`: update after implementation.
