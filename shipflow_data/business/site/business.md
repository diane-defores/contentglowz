...
supersedes: []
next_step: /sf-docs audit shipflow_data/business/site/business.md
---
# Business Context
...
The site should position ContentGlowz as a practical execution layer with transparent limitations:
...
- Landing-page visitors evaluating ContentGlowz.
...
- Any change to business claims should be reflected in `shipflow_data/business/site/branding.md` and `shipflow_data/technical/site/guidelines.md`.
