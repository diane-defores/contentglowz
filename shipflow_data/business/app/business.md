...
next_step: /sf-docs audit shipflow_data/business/app/business.md
---
# Business Context

## Purpose

ContentGlowz is a user-facing Flutter application for creators, independent operators, and small content teams who need to move ideas into published content faster without owning a complex operations stack.

For the ContentGlowz ecosystem, this repository should be treated as the canonical product contract. The supporting site and lab repositories should align to the user-facing promise described here rather than define a competing product narrative.
...
ContentGlowz reduces this friction by keeping the user interface usable in degraded mode and queueing supported backend actions locally until connectivity or API availability is restored.
