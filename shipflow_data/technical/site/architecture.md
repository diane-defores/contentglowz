...
depends_on:
  - AGENT.md@1.0.0
  - shipflow_data/technical/site/context.md@1.0.0
  - shipflow_data/technical/site/context-function-tree.md@1.0.0
evidence:
  - astro.config.mjs
  - src/layouts
  - src/pages
...
next_step: /sf-docs update shipflow_data/technical/site/architecture.md
---

# shipflow_data/technical/site/architecture.md — contentglowz_site (Astro + Node + Vercel)
