...
- `/home/claude/shipflow/shipflow_data/technical/external-platforms/crewai.md`
...
```bash
python3 /home/claude/shipflow/tools/shipflow_metadata_lint.py shipflow_data/technical/platforms/crewai.md
rg -n "CrewAI|Validation|Maintenance Rule|request-scoped|output_pydantic" shipflow_data/technical/platforms/crewai.md
```
