...
def _run_migrations(conn: Connection) -> None:
    ...
    for stmt in [
        ...
        "CREATE UNIQUE INDEX IF NOT EXISTS idx_video_timelines_active_content ON video_timelines(user_id, project_id, content_id, format_preset) WHERE status = 'active'",
