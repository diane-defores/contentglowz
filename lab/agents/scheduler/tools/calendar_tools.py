...
class CalendarAnalyzer:
    ...
    def __init__(self, data_dir: str = "/root/lab/data/scheduler"):
...
class TimeOptimizer:
    ...
    def __init__(self, config_path: Optional[str] = None):
        self.config_path = config_path or "/root/lab/agents/scheduler/config/calendar_rules.yaml"
    ...
    def generate_calendar_view(
        ...
        try:
            ...
            # Load queue
            queue_file = Path("/root/lab/data/scheduler/content_queue.json")
