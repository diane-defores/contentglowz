...
- `contentglowz_app` (Flutter application),
- `contentglowz_site` (landing pages + auth handoff flow),
...
`contentglowz_lab` remains the authenticated boundary for video preview/final
