...
class CalendarAnalyzer:
    ...
    def __init__(self, data_dir: str = "/root/contentglowz_lab/data/scheduler"):
...
class TimeOptimizer:
    ...
    def __init__(self, config_path: Optional[str] = None):
        self.config_path = config_path or "/root/contentglowz_lab/agents/scheduler/config/calendar_rules.yaml"
    ...
    def generate_calendar_view(
        ...
        try:
            ...
            # Load queue
            queue_file = Path("/root/contentglowz_lab/data/scheduler/content_queue.json")
