import type { ContentFlowTimelineProps } from "./ContentFlowTimelineVideo";

export const verticalTimelineFixture: ContentFlowTimelineProps = {
...
export const landscapeTimelineFixture: ContentFlowTimelineProps = {
