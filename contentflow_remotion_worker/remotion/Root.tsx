...
import {
  ContentFlowTimelineVideo,
  type ContentFlowTimelineProps,
...
const calculateContentFlowTimelineMetadata: CalculateMetadataFunction<ContentFlowTimelineProps> = ({
  props,
...
export const RemotionRoot = () => {
  return (
    <>
      ...
      />
      <Composition
        id="ContentFlowTimelineVideo"
        component={ContentFlowTimelineVideo}
        ...
        schema={contentFlowTimelinePropsSchema}
        defaultProps={verticalTimelineFixture}
        calculateMetadata={calculateContentFlowTimelineMetadata}
      />
    </>
  );
};
