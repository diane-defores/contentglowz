...
NEWSLETTER_IMAP_ARCHIVE=Newsletters/Processed
```
...
4. **Create Gmail Labels**:
   ...
   - `Newsletters/Processed` - Archive for processed emails
...
3. **Archive Stage** (IMAP only): Processed emails are moved to `Newsletters/Processed`
