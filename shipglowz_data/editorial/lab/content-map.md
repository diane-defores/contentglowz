...
evidence:
  - README.md
  - CLAUDE.md
  - shipglowz_data/workflow/specs/lab/DRIP_IMPLEMENTATION.md
  - shipglowz_data/workflow/specs/lab/ANALYSIS-drip-integration-with-existing.md
  - shipglowz_data/workflow/specs/lab/SPEC-backend-persona-autofill-repo-understanding-user-keys.md
  - shipglowz_data/workflow/specs/lab/social-listener.md
  - api/routers/*.py
  - agents/
  - tests/
depends_on:
  ...
  - shipglowz_data/technical/lab/guidelines.md@1.0.0
supersedes: []
content_surfaces:
  - api_endpoints
  - agent_modules
...
next_step: /sf-docs audit shipglowz_data/editorial/lab/content-map.md
---

# shipglowz_data/editorial/lab/content-map.md
...
- `shipglowz_data/business/business.md`, `shipglowz_data/branding/branding.md`, `shipglowz_data/technical/lab/guidelines.md` — contrats décisionnels.
- `docs` technique manquant (non présent dans ce repo).
- `shipglowz_data/workflow/specs/lab/*.md` — spécifications d’implémentation et d’évolution.
