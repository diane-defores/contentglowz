...
evidence:
  ...
  - "README.md"
  - "CLAUDE.md"
  - "shipglowz_data/workflow/specs/app/*.md"
  - "CHANGELOG.md"
...
next_step: "/sf-docs audit shipglowz_data/editorial/app/content-map.md"
---
...
- `shipglowz_data/workflow/specs/app/*.md` (active spec set for current and next implementation phase).
