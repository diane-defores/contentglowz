...
| --- | --- | --- | --- | --- |
| `/` via `src/pages/index.astro` | Explain ContentGlowz and move qualified visitors toward the app | Open app or start/sign in | `shipglowz_data/business/business.md`, `shipglowz_data/product/site/product.md`, `shipglowz_data/gtm/site/gtm.md` | High: homepage copy affects positioning and claims |
...
| `/launch` | Route users into the app experience | Continue to app | `shipglowz_data/product/site/product.md`, app handoff config | Medium: app URL and auth state must stay current |
