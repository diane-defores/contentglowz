...
| `src/content.config.ts` | Runtime content schema | Do not add ShipGlowz metadata unless the schema explicitly accepts it. |
...
- Public claims must not exceed `shipglowz_data/business/business.md`, `shipglowz_data/product/site/product.md`, `shipglowz_data/branding/branding.md`, `shipglowz_data/gtm/site/gtm.md`, verified behavior, or claim-register evidence.
