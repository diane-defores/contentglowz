...
- [x] Reclassify `app/TASKS.md` as a deprecated local façade and keep canonical tracker ownership in `shipglowz_data/workflow/app/TASKS.md`.
- [x] Reclassify `app/AUDIT_LOG.md` as a deprecated local façade and keep canonical audit ownership in `shipglowz_data/workflow/app/AUDIT_LOG.md`.
...
🟢 [app] task: Restore French translation coverage for app UI keys | status: done | area: translate
