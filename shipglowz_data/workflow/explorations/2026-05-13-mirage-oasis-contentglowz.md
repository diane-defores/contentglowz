...
- `shipglowz_data/workflow/TASKS.md` - current priorities: design tokens, dual-mode AI runtime, project asset library, Flux/Image Robot, not realtime video.
- `shipglowz_data/workflow/explorations/2026-05-11-contentglowz-migration-remaining-ideas.md` - existing stance: contentglowz is inspiration only, not code to port.
...
- `shipglowz_data/technical/lab/architecture.md` and `shipglowz_data/technical/app/architecture.md` - confirmed FastAPI/Flutter/Clerk/Turso boundaries.
