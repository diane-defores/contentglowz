...
- `shipglowz_data/business/business.md@1.0.0`, `shipglowz_data/branding/branding.md@1.0.0`, `shipglowz_data/branding/branding.md@1.0.0`.
...
- Ajouter ou mettre a jour une note courte dans `README.md` ou `shipglowz_data/technical/SETUP.md` sur la regeneration des tokens.
...
- [ ] Tache 11 : Mettre a jour la page design et la documentation de generation
  - Fichier : `site/src/pages/design.astro`, `README.md` ou `shipglowz_data/technical/SETUP.md`
...
- [ ] Tache 13 : Validation finale et preuve visuelle
  - Fichier : aucun ou rapport court dans `shipglowz_data/workflow/qa/`
