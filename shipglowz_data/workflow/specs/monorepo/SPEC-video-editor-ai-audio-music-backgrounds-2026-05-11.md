...
- Ready Remotion editor foundation: `shipglowz_data/workflow/specs/monorepo/SPEC-remotion-video-editor-workflow-2026-05-11.md`.
- Ready render service foundation: `shipglowz_data/workflow/specs/monorepo/remotion-render-service-integration.md`.
- Ready visual assets UI: `shipglowz_data/workflow/specs/app/SPEC-editor-linked-ai-visuals-ui-2026-05-11.md`.
- Ready quotas/billing foundation: `shipglowz_data/workflow/specs/SPEC-ai-generation-quotas-billing-2026-05-11.md`.
- Ready BYOK foundation: `shipglowz_data/workflow/specs/lab/SPEC-strict-byok-llm-app-visible-ai.md`.
- Existing app files:
  - `app/lib/router.dart`
