...
depends_on:
  ...
  - artifact: "shipglowz_data/workflow/specs/app/PRD-lifetime-deal-early-bird-payg.md"
...
- Existing Flux foundation spec: `shipglowz_data/workflow/specs/SPEC-flux-ai-provider-image-robot-2026-05-11.md`.
- Existing BYOK/product framing: `shipglowz_data/workflow/specs/app/PRD-lifetime-deal-early-bird-payg.md`.
- Existing BYOK enforcement spec: `shipglowz_data/workflow/specs/lab/SPEC-strict-byok-llm-app-visible-ai.md`.
...
- Project language guidelines: `shipglowz_data/technical/lab/guidelines.md`, `shipglowz_data/technical/app/guidelines.md`, and `shipglowz_data/technical/site/guidelines.md`.
...
|----------|-------|-------|--------|--------|-----------|
| 2026-05-11 15:02:22 UTC | sf-spec | gpt-5.5 | Created draft spec for future AI generation quotas, billing, and cost controls. | Draft saved with product decisions captured as Open Questions. | `/sf-ready shipglowz_data/workflow/specs/SPEC-ai-generation-quotas-billing-2026-05-11.md` |
| 2026-05-11 15:38:45 UTC | sf-spec | GPT-5 Codex | Integrated product decisions for hard quota block, PAYG, LTD/BYOK separation, refund-on-failure, and user-scoped limits. | Draft updated; remaining blockers narrowed to unit/pricing/checkout/retry/ops details. | `/sf-ready shipglowz_data/workflow/specs/SPEC-ai-generation-quotas-billing-2026-05-11.md` |
