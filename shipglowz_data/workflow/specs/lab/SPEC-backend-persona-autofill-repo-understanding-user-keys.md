...
supersedes: []
evidence: []
next_step: "/sf-docs audit shipglowz_data/workflow/specs/lab/SPEC-backend-persona-autofill-repo-understanding-user-keys.md"
---
...
- [ ] Tâche 2 : Garantir la table des credentials utilisateur
  - Fichier : `lab/api/services/user_key_store.py`
...
- [ ] Tâche 4 : Introduire le chiffrement applicatif
  - Fichier : `lab/api/services/crypto.py`
...
- [ ] Tâche 5 : Déclarer OpenRouter comme seule intégration user key V1
  - Fichier : `lab/api/models/user_data.py`
...
- [ ] Tâche 7 : Unifier les modèles `psychology`
  - Fichier : `lab/api/models/psychology.py`
...
- [ ] Tâche 9 : Exposer les endpoints d’intégration OpenRouter
  - Fichier : `lab/api/routers/settings_integrations.py`
...
- [ ] Tâche 10 : Créer le service runtime LLM utilisateur
  - Fichier : `lab/api/services/user_llm_service.py`
...
- [ ] Tâche 11 : Créer le service `repo_understanding`
  - Fichier : `lab/api/services/repo_understanding_service.py`
...
- [ ] Tâche 12 : Définir les modèles draft persona
  - Fichier : `lab/api/models/persona_draft.py`
...
- [ ] Tâche 13 : Ajouter les routes draft persona
  - Fichier : `lab/api/routers/personas.py`
...
- Ajouter `cryptography>=42,<44` à `lab/requirements.txt`
...
- `lab/api/models/persona_draft.py`
- `lab/tests/test_persona_contracts.py`
- `lab/tests/test_settings_integrations_router.py`
- `lab/tests/test_persona_draft_route.py`
