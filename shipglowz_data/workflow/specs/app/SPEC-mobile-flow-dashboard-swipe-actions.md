...
supersedes: []
evidence:
  - "app/lib/presentation/screens/feed/feed_screen.dart currently repeats Review creation settings in the hero and Next best actions."
  - "app/lib/presentation/screens/feed/feed_screen.dart currently shows empty status cards for pending review, drip plans, queued actions, and history even when counts are zero."
  - "app/pubspec.yaml already includes flutter_card_swiper and FeedScreen already uses it for review queue cards."
next_step: "/sf-verify shipglowz_data/workflow/specs/app/SPEC-mobile-flow-dashboard-swipe-actions.md"
---
...
- `app/test/presentation/screens/feed/feed_screen_test.dart`
- `app/lib/l10n/app_localizations.dart` if new visible strings require localization entries
- `app/CHANGELOG.md`
...
- Update `app/CHANGELOG.md` with an app behavior entry.
...
- [x] Task 1: Introduce action-card data model and conditional inventory.
  - File: `app/lib/presentation/screens/feed/feed_screen.dart`
...
- [x] Task 6: Rewrite focused widget tests.
  - File: `app/test/presentation/screens/feed/feed_screen_test.dart`
...
- Run `flutter test test/presentation/screens/feed/feed_screen_test.dart` from `app`.
- Run `flutter analyze` from `app` if local Flutter tooling is healthy.
...
|----------|-------|-------|--------|--------|-----------|
| 2026-05-10 | sf-spec | GPT-5 Codex | Created spec for mobile Flow dashboard swipe-action redesign. | reviewed | /sf-ready shipglowz_data/workflow/specs/app/SPEC-mobile-flow-dashboard-swipe-actions.md |
| 2026-05-10 | sf-ready | GPT-5 Codex | Checked structure, behavior contract, implementation tasks, acceptance criteria, security posture, and open questions. | ready | /sf-start shipglowz_data/workflow/specs/app/SPEC-mobile-flow-dashboard-swipe-actions.md |
| 2026-05-10 | sf-start | GPT-5 Codex | Implemented the mobile swipe-action deck, filtered dashboard action inventory, localization entries, tests, and changelog note. | implemented | /sf-verify shipglowz_data/workflow/specs/app/SPEC-mobile-flow-dashboard-swipe-actions.md |
| 2026-05-10 | sf-design | GPT-5 Codex | Orchestrated the dashboard redesign from spec-first gate through local design implementation and checks. | implemented | /sf-verify shipglowz_data/workflow/specs/app/SPEC-mobile-flow-dashboard-swipe-actions.md |
| 2026-05-11 | sf-design | GPT-5 Codex | Added live swipe animation feedback with translation, rotation, directional labels, and exit motion before start/later callbacks. | implemented | /sf-verify shipglowz_data/workflow/specs/app/SPEC-mobile-flow-dashboard-swipe-actions.md |
| 2026-05-11 | sf-design | GPT-5 Codex | Enriched onboarding action cards with icon-led copy blocks and added format-aware review templates for pending content cards. | implemented | /sf-verify shipglowz_data/workflow/specs/app/SPEC-mobile-flow-dashboard-swipe-actions.md |
| 2026-05-11 | sf-design | GPT-5 Codex | Fixed left-swipe completion so the next card starts with a fresh deck state instead of inheriting the outgoing card transform. | implemented | /sf-verify shipglowz_data/workflow/specs/app/SPEC-mobile-flow-dashboard-swipe-actions.md |
