...
### Internal
- `app/AGENT.md`
- `shipglowz_data/technical/app/architecture.md` (si disponible), `shipglowz_data/business/*` uniquement pour contexte
...
- Mettre à jour `shipglowz_data/workflow/specs/app/SPEC-migrate-flutter-core-majors.md` (ou issue liée) si la résolution `record` influence une feuille de route globale de migration.
...
- [ ] Tâche 5: Packager la décision de lot
  - Fichier : `shipglowz_data/workflow/specs/app/SPEC-record-package-migration-flutter-3-41.md`
