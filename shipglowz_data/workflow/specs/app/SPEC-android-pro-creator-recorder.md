...
depends_on:
  ...
  - artifact: "shipglowz_data/technical/app/flutter-app-shell-and-capture.md"
    artifact_version: "0.1.0"
    required_status: "draft"
  - artifact: "shipglowz_data/workflow/specs/app/SPEC-android-device-screen-capture.md"
    artifact_version: "1.0.0"
    required_status: "active"
  - artifact: "shipglowz_data/workflow/explorations/2026-06-12-android-native-vs-custom-screen-recorder.md"
    artifact_version: "1.0.0"
    required_status: "draft"
supersedes:
...
- Manual checklist artifact required:
  - `shipglowz_data/workflow/test-checklists/android-pro-creator-recorder.md`
- Exceptions:
...
- Update `shipglowz_data/technical/app/flutter-app-shell-and-capture.md` after implementation to reflect the new recorder architecture and validation commands.
- Update `shipglowz_data/technical/app/guidelines.md` with recorder-specific capability gating, diagnostics redaction, and cleanup invariants.
...
- [ ] Task 17: Create manual recorder QA checklist.
  - File: `shipglowz_data/workflow/test-checklists/android-pro-creator-recorder.md`
...
- [ ] Task 18: Update docs and legacy V1 contract references.
  - File: `app/README.md`, `shipglowz_data/technical/app/flutter-app-shell-and-capture.md`, `shipglowz_data/technical/app/guidelines.md`, `app/CHANGELOG.md`
...
- Design-system validation:
  - `python3 "${SHIPGLOWZ_ROOT:-$HOME/shipglowz}/tools/design_system_drift_check.py" --changed --format markdown`
...
- `app/android/app/src/main/kotlin/com/contentglowz/app/capture/ScreenCaptureChannel.kt`
- `app/android/app/src/main/kotlin/com/contentglowz/app/capture/ScreenRecordService.kt`
- `shipglowz_data/technical/app/flutter-app-shell-and-capture.md`
- `shipglowz_data/technical/design-system-authority.md`
- `shipglowz_data/workflow/explorations/2026-06-12-android-native-vs-custom-screen-recorder.md`
