...
- Update `shipglowz_data/product/app/product.md` only if the public product promise changes beyond reliable editing.
- Update `shipglowz_data/workflow/specs/app/SPEC-offline-sync-v2.md` only if queue payloads, cache keys, or offline support semantics change.
- Update `shipglowz_data/workflow/specs/app/SPEC-content-pipeline-unification.md` only if format metadata contracts change.
...
- [ ] Task 1: Ready and implement Spec 1, full body vs preview reliability.
  - File: `shipglowz_data/workflow/specs/app/SPEC-content-editing-full-body-preview.md`
...
- [ ] Task 2: Create child spec for format-aware editor controls.
  - File: `shipglowz_data/workflow/specs/app/SPEC-content-editor-multiformat.md`
...
- [ ] Task 3: Create child spec for creator regeneration and version review.
  - File: `shipglowz_data/workflow/specs/app/SPEC-content-regeneration-loop.md`
...
- [ ] Task 4: Create child spec for publish-after-edit validation.
  - File: `shipglowz_data/workflow/specs/app/SPEC-content-publish-after-edit.md`
