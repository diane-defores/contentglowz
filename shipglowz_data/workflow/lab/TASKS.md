...
- [x] Reclassify `lab/tasks.md` as a deprecated local façade and move canonical backlog ownership to `shipglowz_data/workflow/lab/TASKS.md`.
- [x] Reclassify `lab/TEST_LOG.md` as a deprecated local façade and merge retained QA entries into `shipglowz_data/workflow/qa/TEST_LOG.md`.
- [x] Create canonical technical docs for testing and historical agent/pipeline documentation under `shipglowz_data/technical/lab/`.
- [x] Reduce local `lab/tests/README.md`, `lab/agents/seo/README.md`, and `lab/agents/scheduler/README.md` to migration pointers.
- [x] Consolidate important former `lab/README.md` backend contracts into `shipglowz_data/technical/lab/backend-runtime-and-product-apis.md`.
...
- [ ] Reduce `lab/README.md`, `lab/AGENT.md`, and `lab/CLAUDE.md` further if duplicate operational detail drifts again from `shipglowz_data/technical/lab/*`.
- [ ] Decide whether the monorepo should keep one shared `shipglowz_data/workflow/TASKS.md` in addition to surface-scoped trackers, or keep `shipglowz_data/workflow/<surface>/TASKS.md` as the working pattern.
...
Research source: `shipglowz_data/workflow/research/filmora-gap-analysis-2026-06-29.md`.
...
Spec source: `shipglowz_data/workflow/specs/monorepo/SPEC-ai-first-branded-video-generation-and-swipe-publish-2026-07-04.md`.
...
| Social Listener spec — `shipglowz_data/workflow/specs/lab/social-listener.md` | Done |
