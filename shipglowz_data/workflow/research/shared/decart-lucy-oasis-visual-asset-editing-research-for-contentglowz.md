...
- `shipglowz_data/workflow/specs/SPEC-flux-ai-provider-image-robot-2026-05-11.md` — existing Flux/Image Robot contract.
- `shipglowz_data/workflow/specs/SPEC-ai-visual-reference-upload-advanced-2026-05-11.md` — existing visual reference upload and eligibility contract.
- `shipglowz_data/workflow/specs/SPEC-project-visual-asset-library-2026-05-11.md` — existing project visual asset picker/library contract.
- `shipglowz_data/workflow/specs/SPEC-ai-provider-benchmark-cost-quality-telemetry-2026-05-12.md` — existing internal provider benchmark/cost telemetry contract.
- `shipglowz_data/workflow/specs/monorepo/SPEC-ai-video-broll-generation-workflow-2026-05-13.md` — existing AI b-roll workflow and provider registry framing.
- `shipglowz_data/workflow/specs/monorepo/SPEC-remotion-scene-motion-assistant-2026-05-12.md` — existing guided Remotion motion assistant framing.
