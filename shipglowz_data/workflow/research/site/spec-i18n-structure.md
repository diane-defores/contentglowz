...
- Les textes produit doivent rester alignés avec `shipglowz_data/business/business.md` et `shipglowz_data/branding/branding.md`: pas de promesse d'automatisation totale, garder le framing human-in-the-loop.
...
- Ajouter une note dans `shipglowz_data/editorial/site/content-map.md` ou doc équivalente si elle existe et est maintenue.
- Ne pas modifier `shipglowz_data/business/business.md` et `shipglowz_data/branding/branding.md` sauf si l'implémentation change les promesses produit.
...
- [ ] Task 3: Add UI translation dictionary
  ...
  - Notes: Keep copy concise and aligned with `shipglowz_data/branding/branding.md`; French uses tutoiement.
...
- [ ] Task 11: Update docs
  - Files: `README.md`, `CLAUDE.md`, optionally `shipglowz_data/editorial/site/content-map.md`
...
- Stop and ask for product review if French copy requires business promises not present in `shipglowz_data/business/business.md` or `shipglowz_data/branding/branding.md`.
