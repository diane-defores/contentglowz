...
- `/home/claude/my-robots/chatbot/middleware.ts`
- `/home/claude/my-robots/chatbot/app/api/projects/route.ts`
- `/home/claude/my-robots/chatbot/app/api/settings/route.ts`
- `/home/claude/my-robots/chatbot/app/api/psychology/route.ts`
- `/home/claude/my-robots/chatbot/app/api/psychology/personas/route.ts`
- `/home/claude/my-robots/chatbot/lib/db/schema.ts`
- `/home/claude/my-robots/chatbot/lib/db/queries.ts`
...
Fichiers de reference:
- `/home/claude/my-robots-app/lib/main.dart`
- `/home/claude/my-robots-app/lib/router.dart`
- `/home/claude/my-robots-app/lib/data/services/api_service.dart`
- `/home/claude/my-robots-app/lib/providers/providers.dart`
- `/home/claude/my-robots-app/lib/presentation/screens/entry/entry_screen.dart`
- `/home/claude/my-robots-app/lib/presentation/screens/onboarding/onboarding_screen.dart`
...
- `/home/claude/my-robots/api/auth/clerk.py`
  - validation JWT Clerk
  - chargement/caching JWKS
  - extraction `sub`

- `/home/claude/my-robots/api/dependencies/auth.py`
  - dependency `get_current_user()`
  - dependency `require_current_user()`

- `/home/claude/my-robots/api/models/me.py`
- `/home/claude/my-robots/api/models/settings.py`
- `/home/claude/my-robots/api/models/persona.py`
- `/home/claude/my-robots/api/models/creator_profile.py`
- `/home/claude/my-robots/api/models/bootstrap.py`

- `/home/claude/my-robots/api/repositories/`
...
- `/home/claude/my-robots/api/routers/me.py`
- `/home/claude/my-robots/api/routers/settings.py`
- `/home/claude/my-robots/api/routers/personas.py`
- `/home/claude/my-robots/api/routers/creator_profile.py`
- `/home/claude/my-robots/api/routers/bootstrap.py`

### Fichiers a modifier

- `/home/claude/my-robots/api/main.py`
  - ajouter la nouvelle auth dependency/middleware
  - inclure les nouveaux routers
  - mettre a jour la doc/CORS si necessaire

- `/home/claude/my-robots/api/routers/projects.py`
  - remplacer `default-user` par le vrai user Clerk

- `/home/claude/my-robots/api/routers/content.py`
- `/home/claude/my-robots/api/routers/status.py`
- `/home/claude/my-robots/api/routers/publish.py`
