...
# ARCHITECTURE.md — contentflow_site (Astro + Node + Vercel)
...
- Les données de contenu affichées en page d’accueil, FAQ, pricing et CTA doivent être maintenues cohérentes avec `BRANDING.md` et `BUSINESS.md`.
