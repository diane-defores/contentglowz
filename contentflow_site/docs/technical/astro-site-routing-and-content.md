...
supersedes: []
evidence:
  - "Astro public site source is present under contentflow_site/src."
...
This module covers the ContentFlow Astro site routing, layouts, shared components, runtime content schema, SEO metadata, sitemap behavior, and build validation. Agents should load it before changing public routes, page copy structure, content collection schemas, canonical URLs, language routing, or Vercel-facing build behavior.
...
- Public claims must not exceed `BUSINESS.md`, `PRODUCT.md`, `BRANDING.md`, `GTM.md`, verified behavior, or claim-register evidence.
