...
- If content needs ShipFlow governance, place the governance artifact under `docs/editorial/`, `docs/technical/`, or `specs/`, then reference the runtime content path.
