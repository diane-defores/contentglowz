...
| --- | --- | --- | --- | --- |
| Marketing home | `src/pages/index.astro` | Public positioning and primary CTA | `BUSINESS.md`, `PRODUCT.md`, `BRANDING.md`, `GTM.md` | Offer, ICP, CTA, claim, or product behavior changes |
| Launch handoff | `src/pages/launch.astro` | App entry handoff | `PRODUCT.md`, app route contracts | Auth/app URL or onboarding changes |
