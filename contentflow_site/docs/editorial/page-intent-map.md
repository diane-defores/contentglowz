...
| --- | --- | --- | --- | --- |
| `/` via `src/pages/index.astro` | Explain ContentFlow and move qualified visitors toward the app | Open app or start/sign in | `BUSINESS.md`, `PRODUCT.md`, `GTM.md` | High: homepage copy affects positioning and claims |
| `/launch` | Route users into the app experience | Continue to app | `PRODUCT.md`, app handoff config | Medium: app URL and auth state must stay current |
