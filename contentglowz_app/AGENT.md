...
supersedes: []
linked_systems:
  - "contentglowz_lab FastAPI backend"
  - "ClerkJS auth assets"
next_review: "2026-07-26"
next_step: "/sf-docs update AGENT.md"
---

# AGENT — contentglowz_app

## Mission
- Keep this repository as the Flutter product application for ContentGlowz and maintain all technical decisions described in this artifact and aligned artifacts (`README.md`, `CLAUDE.md`, `shipflow_data/workflow/specs/**/*.md`).
