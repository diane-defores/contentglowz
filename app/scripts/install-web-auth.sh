...
sed \
  ...
  -e "s/__BUILD_ID__/$(escape_replacement "$BUILD_ID_VALUE")/g" \
  ...
  -e "s/__BUILD_AT_PARIS__/$(escape_replacement "$BUILD_AT_PARIS_VALUE")/g" \
  -e "s/__BUILD_AT_UTC__/$(escape_replacement "$BUILD_AT_UTC_VALUE")/g" \
