...
export const improveMeshTool = tool({
  description: "Generate an improvement plan for an existing topical mesh. Analyzes gaps and suggests phased improvements.",
  inputSchema: z.object({
    url: z.string().describe("The GitHub repository URL to analyze"),
    newTopics: z.array(z.string()).optional().describe("New topics to potentially add"),
    competitorTopics: z.array(z.string()).optional().describe("Topics from competitors to consider"),
