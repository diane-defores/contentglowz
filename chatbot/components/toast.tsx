...
function Toast(props: ToastProps) {
	...
	return (
		<div className="flex toast-mobile:w-[356px] w-full justify-center">
			<div
				className={cn(
					"flex toast-mobile:w-fit w-full flex-row gap-3 rounded-lg bg-zinc-100 dark:bg-zinc-800 p-3",
			...
			>
				...
				<div className="text-sm text-zinc-950 dark:text-zinc-50" ref={descriptionRef}>
					{description}
				</div>
			</div>
		</div>
