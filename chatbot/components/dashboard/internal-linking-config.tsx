				...
				<div className="space-y-6">
					...
					<div className="space-y-3">
						...
						>
							...
							<SelectContent>
								<SelectItem value="new_content_only">
									New Content Only
								</SelectItem>
								<SelectItem value="include_existing">
					...
					<div className="space-y-3">
						...
						<Select
							...
							onValueChange={(
								value: InternalLinkingConfig["personalizationLevel"],
					...
					<div className="space-y-3">
						...
						<div className="grid grid-cols-2 gap-2">
							{businessObjectives.map((objective) => {
								...
								const isSelected = config.businessObjectives.includes(
									objective.id,
								);
						...
						<div className="space-y-3">
							...
							<Input
								...
								onChange={(e) =>
									onConfigChange({
										...config,
										targetAuthority: Number(e.target.value),
									})
								}
							/>
						</div>
						<div className="space-y-3">
							...
							<Input
								...
								onChange={(e) =>
									onConfigChange({
										...config,
										targetConversionRate: Number(e.target.value),
									})
								}
							/>
						</div>
