...
1. Content Kanban - Integrate drag-drop columns into chatbot's content review
2. Research Page Overhaul - Replace current research chat with v0 chatbot interface
3. Website Landing Page - Convert v0-pointer sections to Astro components
4. Terminal Theme - Add .terminal CSS theme to chatbot's theme system
5. Backlink Tool - Wire to real API and add as chatbot dashboard tab
6. Project Dashboard - Use quality-control structure for overview page
...
_Sources: Grigora AppSumo analysis, codebase audit_
