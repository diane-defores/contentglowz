"""Canonical ContentFlow video timeline API models."""
...
class ContentFlowTimelineProps(BaseModel):
    model_config = ConfigDict(extra="forbid")

    composition_id: Literal["ContentFlowTimelineVideo"] = "ContentFlowTimelineVideo"
    timeline_id: str
    version_id: str
    format: dict[str, Any]
