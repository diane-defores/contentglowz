"""Renderer adapter boundary for ContentFlow video timelines."""
    ...
    async def request_render(
        ...
        *,
        ...
        raise VideoRendererUnavailableError(
            "ContentFlow timeline Remotion composition is not enabled yet"
        )
    ...
    async def _create_worker_payload(
        ...
        *,
        ...
        return {
            ...
            "templateId": "contentflow-timeline-v1",
